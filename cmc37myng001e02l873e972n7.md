...
* From the `homelab` terminal (`CTRL` + `ALT` + `T`) that is connected to the remote system, I install Fail2Ban:
...
## OPTIONAL: Formatting the Drives.

* I list the block devices:
...
## OPTIONAL: Changing the Boot Order.
