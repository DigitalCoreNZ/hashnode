...
The following describes setting up the remote PiLab systems in preparation for the MicroK8s cluster. These settings must also be applied to the [eight NucLab containers](https://solodev.app/installing-proxmox-ve-on-an-intel-nuc-10#heading-creating-a-new-account-for-the-container).
