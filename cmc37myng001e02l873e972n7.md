...
> NOTE: Now that the M.2 NVMe drives have been imaged and installed, I now need to tell the Pi5 SBCs to boot into the SSDs.

---

## Creating a Bootable Pi5 Micro SD Card.

> NOTE: For this process, I use a micro SD card and a USB card reader.

* I insert the micro SD into the USB card reader.
...
* I choose ‘Raspberry Pi 5’ as the `Raspberry Pi Device`.
    

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1753067873642/008c5b43-b1f3-4c18-aaea-a6c98f2d9e1f.png align="center")

* I choose ‘Raspberry Pi OS (64-bit)’ as the `Operating System`:
    

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1753067993993/0567a267-76cb-469e-bfda-6d9b713ff9ba.png align="center")

* I choose the ‘SD Card Reader (bootfs, rootfs)’ as the `Storage`:
    

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1753068103822/603d20de-058f-470c-9f91-e4135cbbbf5d.png align="center")

* I click the `Next` button.
    
* I click the `Edit Settings` button to edit the ‘Use OS Customisation’ settings.
    
* In the ‘GENERAL’ tab, I “Set hostname” to ‘PiLab1’ (or whatever hostname is appropriate), “Set username and password”, and “Set locale settings”:
    

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1753068604189/f1593a53-40d1-41be-8fd3-ebe515c14c9f.png align="center")

* In the ‘SERVICES’ tab, I “Enable SSH” to “Use password authentication”:
    

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1753068784179/38b1b0d4-2c70-427c-ab6b-701ce1c198d8.png align="center")

> NOTE: I will change this setting later in this post.

* In the ‘OPTIONS’ tab, I “Eject media when finished”:
    

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1753068971828/072a4409-9955-492d-94a0-5f0379bc1a0f.png align="center")

* I click the `Save` button.
    
* I click the `Yes` to apply the ‘Use OS Customisation’ settings.
    
* After reading the `Warning` dialog, I click the `Yes` button.
    

> NOTE: After the Raspberry Pi OS has been installed on to the micro SD card, the USB card reader will automatically from my PC:
> 
> ![](https://cdn.hashnode.com/res/hashnode/image/upload/v1753069711631/8745ce34-5023-42a4-ba73-c989ab7fd9fc.png align="center")

* After the Raspberry Pi Imager has finished, I remove the USB card reader from my PC.
    
* I remove the micro SD card from the USB card reader.
    

> NOTE: The next step is to use the micro SD card to boot into the Raspberry Pi OS.

---

## Booting into the Raspberry Pi OS.

* I insert the newly imaged micro SD card into the Pi5 micro SD card slot.
    
* I add a second micro SD card into the USB card reader.
    
* I insert the USB card reader into a Pi5 USB port.
    
* I power up the Pi5 and let it boot into the OS.
    

---

## Using the Raspberry Pi Imager on the Pi5.
