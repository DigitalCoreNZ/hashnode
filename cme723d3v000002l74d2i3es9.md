...
Although the following are “optional settings“, they have become my standard practice when setting up BMAD on a fresh installation of Ubuntu.

### Cleaning Up the Modes in the .roomodes File.
...
> HINT: Thanks to the BMAD Method doing most of the “ heavy lifting“, I can use cheaper AI models like OpenAI: gpt-oss-120b, Qwen: Qwen3 235B A22B Thinking 2507, and Google: Gemini Flash 2.0 (I use [OpenRouter.ai](https://openrouter.ai/) to gain access to most of the AI models from nearly all of the AI companies).
