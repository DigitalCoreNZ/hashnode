...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1754925873913/760df484-1d04-4d57-8b45-77f5e90700d5.png align="center")
...
* I replace the white text with `Path: ./.bmad-core/agents/analyst.md` command.
...
> 
> In the Roo Code prompt dialog box, I can type a slash (/) and the custom `/analyst` command is displayed, and available, which is set call on the `analyst.md` file. If I am in any other mode, the `/analyse` command will call the Business Analyst directly:
> 
