...
> NOTE: I use the `user-guide.md` file as a reference while creating these custom slash (/) commands.

* I repeat this custom command process for any of the the other agents I want to use.
